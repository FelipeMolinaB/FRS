...
sudo docker run -it \
  ...
  --privileged -v /tmp/.X11-unix:/tmp/.X11-unix:ro  \
	--device /dev/video0 \
	-v /media/sf_face_computer_backup/app_face_dlib:/root/openface/demos/web\
	-v /media/sf_face_computer_backup/face_dlib/db/models_per_person/svm_binary/models:/root/openface/demos/web/project/binary_svm_models\
	-v /media/sf_face_computer_backup/face_dlib/db/models_per_person/general_svm:/root/openface/demos/web/project/general_svm\
